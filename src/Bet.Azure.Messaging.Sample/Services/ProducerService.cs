...
namespace Bet.Azure.Messaging.Sample.Services
{
    public class ProducerService
    {
        ...
        public Task SendToTopic(CancellationToken cancellationToken)
        {
            ...
            return topic.SendMessageAsync<Usps>(uspsMessage, "usps");
        }
    }
}
